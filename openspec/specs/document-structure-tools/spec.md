...
Define the contract for generic document structure inspection tools that return ordered logical unit summaries for indexed Office documents across all supported file types.
