...
Define the contract for DOCX document block inspection and block-level write tools that operate on ordered paragraph and table blocks within indexed Word documents.
